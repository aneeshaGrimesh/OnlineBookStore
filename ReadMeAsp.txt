Step 1: Double Click on OnlineBookShopTuto.sln
Step2 : In the shared folder, copy the database file called "BookShopASPDB.mdf" and paste it in your documents
...
Step7 : Copy the connection string and replace it in Models folder  -> Functions.cs class file
